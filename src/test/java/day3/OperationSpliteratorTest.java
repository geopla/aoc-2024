...
class OperationSpliteratorTest {
    ...
    void shouldCreateSingleElementStream() {
        ...
        assertThat(operationStream).containsExactly(new Operation.Multiplier("2", "4"));
    }
    ...
    void shouldDetectOperationFromCorruptedMemoryExample() {
        ...
        assertThat(operationStream).containsExactly(
                new Operation.Multiplier("2", "4"),
                new Operation.Multiplier("5", "5"),
                new Operation.Multiplier("11", "8"),
                new Operation.Multiplier("8", "5")
        );
    }
